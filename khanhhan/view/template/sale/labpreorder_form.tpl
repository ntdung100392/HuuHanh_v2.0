      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-return" class="form-horizontal">
          ...
          <div class="tab-pane active" id="tab-general">
            <fieldset>
              <legend><?php echo $tab_labpreorder; ?></legend>
            ...
            <fieldset>
              <legend><?php echo $tab_product; ?></legend>
              <div class="form-group required">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-labpreorder-reason"><?php echo $entry_labpreorder_reason; ?></label>
                <div class="col-sm-10">
                  <select name="labpreorder_reason_id" id="input-labpreorder-reason" class="form-control">
                    <?php foreach ($labpreorder_reasons as $labpreorder_reason) { ?>
                    <?php if ($labpreorder_reason['labpreorder_reason_id'] == $labpreorder_reason_id) { ?>
                    <option value="<?php echo $labpreorder_reason['labpreorder_reason_id']; ?>" selected="selected"><?php echo $labpreorder_reason['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $labpreorder_reason['labpreorder_reason_id']; ?>"><?php echo $labpreorder_reason['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-labpreorder-action"><?php echo $entry_action; ?></label>
                <div class="col-sm-10">
                  <select name="labpreorder_action_id" id="input-labpreorder-action" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="labpreorder_status_id" id="input-labpreorder-status" class="form-control">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="labpreorder_status_id" id="input-labpreorder-status" class="form-control">
                    <?php foreach ($labpreorder_statuses as $labpreorder_status) { ?>
                    <?php if ($labpreorder_status['labpreorder_status_id'] == $return_status_id) { ?>
                    <option value="<?php echo $labpreorder_status['labpreorder_status_id']; ?>" selected="selected"><?php echo $labpreorder_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $labpreorder_status['labpreorder_status_id']; ?>"><?php echo $labpreorder_status['name']; ?></option>
                    <?php } ?>
...
$('#history').load('index.php?route=sale/labpreorder/history&token=<?php echo $token; ?>&return_id=<?php echo $labpreorder_id; ?>');

$('#button-history').on('click', function(e) {
  e.preventDefault();

	$.ajax({
		url: 'index.php?route=sale/labpreorder/history&token=<?php echo $token; ?>&return_id=<?php echo $labpreorder_id; ?>',
		type: 'post',
		dataType: 'html',
