<?php
// Heading
$_['heading_title']    = 'Repair Status';

// Text
$_['text_success']     = 'Success: You have modified return statuses!';

// Column
$_['column_name']      = 'Repair Status Name';
$_['column_action']    = 'Action';

// Entry
$_['entry_name']       = 'Repair Status Name:';

// Error
$_['error_permission'] = 'Warning: You do not have permission to modify return statues!';
$_['error_name']       = 'Repair Status Name must be between 3 and 32 characters!';
