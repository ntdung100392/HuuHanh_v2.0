...
<title>Repair Service Form IntelligentUAS</title>
<style type="text/css">
                ...
                <tr>
                  <td valign="top" class="bodyContent"><!-- // Begin Module: Standard Content \\ -->
                    ...
                    <table border="0" cellpadding="20" cellspacing="0" width="100%">
                      <tr>
                        <td valign="top"><h1 class="h1">Order Information</h1>
                          <p>
                            <strong>REPAIR (RSO) Number:</strong> <font color="red"><?php echo $repair_id; ?></font><br />
                          ...
                          <strong>Faulty or other details: </strong></p>
