      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-return" class="form-horizontal">
          ...
          <div class="tab-pane active" id="tab-general">
            <fieldset>
              <legend><?php echo $tab_repair; ?></legend>
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-repair-reason"><?php echo $entry_repair_reason; ?></label>
                <div class="col-sm-10">
                  <select name="repair_reason_id" id="input-repair-reason" class="form-control">
                    <?php foreach ($repair_reasons as $repair_reason) { ?>
                    <?php if ($repair_reason['repair_reason_id'] == $repair_reason_id) { ?>
                    <option value="<?php echo $repair_reason['repair_reason_id']; ?>" selected="selected"><?php echo $repair_reason['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $repair_reason['repair_reason_id']; ?>"><?php echo $repair_reason['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-repair-action"><?php echo $entry_action; ?></label>
                <div class="col-sm-10">
                  <select name="repair_action_id" id="input-repair-action" class="form-control">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-repair-status"><?php echo $entry_repair_status; ?></label>
                <div class="col-sm-10">
                  <select name="repair_status_id" id="input-repair-status" class="form-control">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="repair_status_id" id="input-repair-status" class="form-control">
                    <?php foreach ($repair_statuses as $repair_status) { ?>
                    <?php if ($repair_status['repair_status_id'] == $return_status_id) { ?>
                    <option value="<?php echo $repair_status['repair_status_id']; ?>" selected="selected"><?php echo $repair_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $repair_status['repair_status_id']; ?>"><?php echo $repair_status['name']; ?></option>
                    <?php } ?>
...
$('#history').load('index.php?route=sale/repair/history&token=<?php echo $token; ?>&return_id=<?php echo $repair_id; ?>');

$('#button-history').on('click', function(e) {
  e.preventDefault();

	$.ajax({
		url: 'index.php?route=sale/repair/history&token=<?php echo $token; ?>&return_id=<?php echo $repair_id; ?>',
		type: 'post',
		dataType: 'html',
