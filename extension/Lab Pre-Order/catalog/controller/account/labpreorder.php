...
class ControllerAccountlabpreorder extends Controller {
    ...
    public function info() {
        ...
        if ($labpreorder_info) {
            ...
            //$data['reason'] = $labpreorder_info['reason'];
...
//                $mail->setTo('support@intelligentuas.com');
                ...
                $mail->setSubject('Copy : labpreorder confirm from ' . $this->request->post['email']);
                $mail->send();
            }
        ...
        /* if (isset($this->request->post['labpreorder_reason_refund']))
          {
          $data['labpreorder_reason_refund'] = $this->request->post['labpreorder_reason_refund'];
          }
          else
          {
          $data['labpreorder_reason_refund'] = '';
          } */
        ...
        $labpreorder_images = array();

        if (isset($this->request->post['image'])) {
            $labpreorder_images = $this->request->post['image'];
        }

        $data['labpreorder_images'] = array();
        $this->load->model('tool/image');

        foreach ($labpreorder_images as $labpreorder_image) {
