    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="tab-content">
          ...
          <tr>
            <td><?php echo $text_labpreorder_reason; ?></td>
            <td><?php echo $labpreorder_reason; ?></td>
          </tr>
          <tr>
          ...
          <tr>
                        <td colspan="2">
                            <?php foreach ($labpreorder_images as $img) { ?>
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_labpreorder_status; ?></label>
                  <div class="col-sm-10">
