$(document).ready(function() {
	$(window).load(function() {
		...
		var generateLIs = function(searchVal, fromProducts) {
			...
			var viewAllHref = 'index.php?route='+routeToController+'&'+searchParam+'='+searchVal;
			...
			$(categories).each(function(index, element) {
				...
				categoryLIs += '<li class="iSearchCategory" onclick="document.location.href=\''+element.href.replace('\'', '\\\'')+'\'">' + categoryName + '</li>';
			});
