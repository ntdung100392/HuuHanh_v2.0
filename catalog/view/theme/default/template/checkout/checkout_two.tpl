<?php echo $header; ?>
<?php if (strpos(__FILE__, 'component') !== false) { // Joomla shop ?>
<link rel="stylesheet" type="text/css" href="components/com_mijoshop/opencart/catalog/view/theme/default/stylesheet/ucstyle.css" />
<?php } else { ?>
<?php if (version_compare(VERSION, '1.5.1.3', '>') == true) {?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/ucstyle.css" />
<?php } else { ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/ucstyle_151.css" />
<?php } ?>
<?php } ?>
  ...
  <div class="content">
    ...
    <div class="uc_checkout_two_left_block">
      ...
      <?php if ($shipping_style == 'select') { ?>
          ...
          <tr>
            <td align="left" width="70%">
              <select name="shipping_method" onchange="updateShippingPaymentTotals();" style="width:100%;" >
				...
				<optgroup label="<?php echo $shipping_method['title'] . ' ' . $shipping_method['error']; $quote_error_count++; ?>"></optgroup>
				<?php } else { ?>
        ...
        <table width="100%" cellpadding="3">
          ...
          <?php } else { ?>
          <tr>
            <td colspan="3"><div class="error"><?php echo $shipping_method['error']; $quote_error_count++; ?></div></td>
          </tr>
          <?php } ?>
          <?php } ?>
        </table>
    ...
    <div class="uc_checkout_two_right_block">
      ...
      <div class="content">
        <table width="100%">
          <tr>
            <?php if ($show_image) { ?><th align="center"><?php echo $column_image; ?></th><?php } ?>
		  ...
		  <tr>
		    <?php if ($show_image) { ?><td align="center" valign="top"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></td><?php } ?>
            ...
            <td align="left" valign="top"><?php echo $product['quantity']; ?></td>
	  ...
	  <?php if (!$this->config->get('uber_checkout_full_width')) { ?>
      <!-- Payment -->
...
<?php if ((!$shipping_methods || $quote_error_count == count($shipping_methods)) && $this->cart->hasShipping()) { ?>
...
$(document).ready(function () {
	...
	updatePayment(); // This is needed to update the tax correctly!
	<?php if ($text_agree) { ?>
